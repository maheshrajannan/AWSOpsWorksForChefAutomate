<powershell>
 ...
 $env:CHEF_SERVER_NAME = "ChefAutomateServerLearning" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "chefautomateserverlearning-r4vqejllbbralyoz.us-east-1.opsworks-cm.io" # FQDN of your Chef Server
