...
CHEF_SERVER_NAME="ChefAutomateServerLearning" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="chefautomateserverlearning-r4vqejllbbralyoz.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
